      ...
      <main id="page-content">
        ...
        <article id="description">
          <div>
            ...
            <div id="add-employee">
              <a href="<?php echo url_for('staff/images.php'); ?>">Back to List</a>
              <a href="<?php echo url_for('/staff/delete-image.php?image_id='. h(u($images['image_id']))); ?>">Delete</a>
              <a href="<?php echo url_for('/staff/edit-image.php?image_id='. h(u($images['image_id']))); ?>">Edit Caption</a>
            </div>
          </div>
          <hr>
